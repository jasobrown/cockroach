...
const (
	...
	//
	BitFamily Family = 21
	// IPRangeFamily is the family of types containing an ordered pair of either IPv4
	// or IPv6 address.
	//
	//   Canonical: N/A
	//   Oid      : <jasobrown hack time>
	//   Width    : 2 * {IPv4|IPv6} address
	//
	// Examples:
	//   IPRange
	//
	IPRangeFamily Family = 22
...
func (Family) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_c67ef3d1fa23c9ff, []int{0}
}
...
func (IntervalDurationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_c67ef3d1fa23c9ff, []int{1}
}
...
func init() { proto.RegisterFile("sql/types/types.proto", fileDescriptor_types_c67ef3d1fa23c9ff) }

var fileDescriptor_types_c67ef3d1fa23c9ff = []byte{
	// 844 bytes of a gzipped FileDescriptorProto
	,
}
